    ...
    >
      ...
      <div className="relative z-10 container px-4 mx-auto flex flex-col items-center text-center pt-20">
        ...
        <h1 className="flex flex-col items-center justify-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#FFF5E1] mb-6 drop-shadow-2xl leading-[1.1]">
          <span className="block">Tôn vinh giá trị của từng hương vị.</span>
          <span className="flex items-center mt-1 sm:mt-2">
            Lan tỏa
            <TextFlip words={["Sự minh bạch", "Vị ngon nguyên bản", "Cam kết an toàn", "Lối sống xanh"]} />
          </span>
        </h1>

        {/* Subheading */}
        <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mb-8 leading-relaxed drop-shadow-md font-light">
          LASTBITE kết nối bạn với những phần ăn chất lượng cao trong ngày từ các nhà hàng, tiệm bánh uy tín. Minh bạch thực đơn, kiểm chứng tận tay – vì một trải nghiệm ẩm thực an toàn và bền vững.
        </p>
        ...
        <div className="mt-10 flex flex-col items-center gap-2 text-white/60 text-sm">
          ...
          <p>Tham gia cùng hàng ngàn người trẻ đang lan tỏa phong cách sống xanh mỗi ngày.</p>
        </div>
